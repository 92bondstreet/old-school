...
function custom_colors_css(){
	...
	<style type="text/css">
		...
		#container, #container2 { background: #<?php echo(get_option($shortname.'_color_bgcolor')); ?>; }
		...
		#sidebar h3.widgettitle { color:#<?php echo(get_option($shortname.'_color_sidebar_titles')); ?>; }
		#footer h3.title { color:#<?php echo(get_option($shortname.'_color_footer_titles')); ?>; }
		#footer .widget, #footer .widget a { color:#<?php echo(get_option($shortname.'_color_footer_links')); ?> !important; }
	</style>
